  ...
  return (
    ...
    >
      ...
      <EditorContent
        ...
        className='font-regular min-h-[186px] cursor-text overflow-hidden border-none px-[16px] py-[12px] text-sm leading-7 break-words text-neutral-500 outline-none [&>div[contenteditable]]:focus:border-none [&>div[contenteditable]]:focus:shadow-none [&>div[contenteditable]]:focus:ring-0 [&>div[contenteditable]]:focus:outline-none'
      />
    </div>
  );
};
